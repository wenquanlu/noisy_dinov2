...
gauss50_200 = get_general_accuracies("output_{}-200".format(noise_type), 40)
...
plt.plot(epochs[-12:], output_noisenoise, marker="o", label="Ablate Denoised Pretraining")
plt.plot(epochs[-12:], no_restart, marker="o", label="Ablate Restarting Training")
plt.plot(epochs, gauss50_200, marker='o', label='Noisy', color='#d62728')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.grid(True)
plt.legend()
plt.savefig("draw/noise2noise_accuracy.png".format(noise_type))