...
PYTHONPATH="PATH_TO_imagenet-1k-experiments" python dinov2/run/eval/linear.py \
    ...
    --num-workers 6 \
    --epochs 20 \
    --pretrained-weights output_gauss255-regularized30_70_16/eval/training_174999/teacher_checkpoint.pth \
    --config-file output_gauss255-regularized30_70_16/config.yaml \
    --output-dir output_gauss255-regularized30_70_16/eval/training_174999/linear \
