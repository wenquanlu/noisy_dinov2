...
from dinov2_reg.eval.log_regression import get_args_parser as get_log_regression_args_parser
from dinov2_reg.logging import setup_logging
from dinov2_reg.run.submit import get_args_parser, submit_jobs
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2_reg.eval.log_regression import main as log_regression_main
